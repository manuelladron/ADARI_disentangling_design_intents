...
<div  align="center">   
  <img width="50%"   src="./media/mCNN_test_sample.png">
  <p style="font-size:10px">Figure 6. Test sample of the m-CNN architecture for matching image and sentence using triplet loss. </p>
</div>
